...
def start_new_game():
    ...
    # FIX: Generate the secret from the difficulty's range (was hardcoded 1-100,
    # which let a "Hard" game pick 74). Suggested by Claude, verified by replay.
...
# FIX: Reset the game when difficulty changes so a previous "lost" status
# doesn't carry over (the Hard -> Easy "Game over" bug).
